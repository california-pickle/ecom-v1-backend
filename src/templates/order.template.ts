...
<div style="border: 2px solid #e5e7eb; border-radius: 8px; padding: 24px; margin-bottom: 30px;">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
    ...
    ${discountAmount > 0 ? `
    <tr>
      <td align="right" style="padding: 6px 0; font-size: 14px; color: #6b7280;">Discount${discountCode ? ` (${discountCode})` : ""}:</td>
      <td align="right" width="110" style="padding: 6px 0; font-size: 14px; color: #16a34a; font-weight: 600;">-$${discountAmount.toFixed(2)}</td>
    </tr>` : ""}
    <tr>
